...
| `08_技法カタログ.md` | 31本から抽出した再利用可能な技法集 |
| `09_マスタープロンプト.md` | 録画用A面／単体B面の2枚建てプロンプト |
...
`.claude/skills/daihon/SKILL.md` に台本執筆の制御層を常駐させてある。
台本・シナリオ系の依頼で自動発動し、文体実測・技法・禁止表現・ai_smell検査を強制する。
※ 新しいセッションから有効（スキルはセッション開始時に読み込まれる）。
