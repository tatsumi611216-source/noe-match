...
TARGETS = {
    ...
    # AI経由（chatgpt/copilot）で実着地が確認されたデータ記事（2026-08-26 GA4実測）
    "members-data": (
        "アプリの公表データの読み方を、週1回",
        "会員数・男女比の公表値と非公表の見分け方を短文で。どれを選ぶか迷ったら、トークでご相談ください。"),
    "compare-20s": (
        "20代のアプリ選びを、公表データで",
        "年代別の向き不向きと公表値の読み方を週1回・短文で。迷ったら、追加後そのままトークでどうぞ。"),
    "compare-price": (
        "料金で選ぶ前に見るべき数字を、週1回",
        "各社の料金と公表値の突き合わせ方を短文で届けます。気になることは、トークでご相談ください。"),
    "omiai-guide": (
        "Omiaiの使いどころを、公表データで",
