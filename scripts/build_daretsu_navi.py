...
FAQ = [
 ...
 ("収録されていない自治体では月何時間使えますか？",
  "国の補助基準の上限は月10時間ですが、子ども・子育て支援法等改正法（令和6年法律第47号）附則第6条の経過措置により、令和8年度と令和9年度は自治体が条例で利用可能時間を月3時間以上10時間未満の範囲に設定できます。報道では約1,700自治体（大半）がこの経過措置を適用しているとされ、収録外の自治体では月10時間より短いことが多い状況です。本ツールに収録した46自治体（東京23区・政令市20市・中核市ほか3市）はいずれも月10時間以上でしたが、これは大都市に限った傾向で、全国の標準ではありません。お住まいの自治体の公式ページで必ず確認してください。"),
 ("本格実施はいつからですか？",
